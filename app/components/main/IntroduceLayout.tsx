...
import LogoText from "../ui/ResponsiveText";
import ResponsiveText from "../ui/ResponsiveText";

export default function IntroduceLayout() {
  return (
    <div className="introLayout w-full h-screen flex justify-between outline outline-1 mb-3 overflow-x-hidden">
      <div className="introLeft w-1/6 h-full flex-col flex OutLine relative">
        <div className="introTextArea w-full h-1/4 absolute left-full flex items-end">
          안녕하세요! 저는 윤준현이라고 합니다. 현재 프론트엔드 개발자
          지망생이며 주로 쓰는 기술은 Reat, Next.js, express 등 입니다.
        </div>
        <div className="w-full h-1/3"></div>
        <div className="imgCardArea w-full h-1/3 OutLine">
