      ...
      <Section className="portfolioRightSection w-1/2 Testing flex flex-col gap-[300px] overflow-x-hidden overflow-y-scroll text-[0.875rem] leading-[120%]">
        ...
        <div className="w-full flex justify-between">
          <TextAlign title="사용된 스택과 링크" type="left">
            ...
            <p>
              {`개인 노션 링크 : `}
              <a rel="noreferrer noopener" target="_blank" href="추후 추가 예정">
        ...
        <div className="w-full flex justify-between items-start">
          <TextAlign title="혼란의 과정" type="left">
            <p>인도, 일본 웹 디자인 트랜드, 수 많은 레퍼런스 페이지를 계속 탐구해 나갔지만 <b>많은 혼란만 있었습니다.</b></p>
            <p>&nbsp;</p>
            <p><b>초보 디자인이라면 느끼는 막막함’</b></p>
            <p>내가 뭘 좋아하는 지도 모르는데’라는 마음은 테마를 결정하는 <br />과정에서부터 삐긋 거리기도 했습니다. </p>
            <p>&nbsp;</p>
        ...
        <div className="w-full flexCenter">
          <TextAlign title="디자인 연구 = 윤준현 연구" type="center">
            <div className="flex flex-col gap-2">
              <p>많은 고민 속 내린 질문 <b>“내 방을 어떻게 꾸미면 좋을까?”</b></p>
              <p>그 결과 저는 <b>미니멀리즘에 매력</b>을 느꼈습니다.</p>
        ...
        <div className="w-full flex justify-between items-start">
          ...
          <p><b>‘어떤 의도로 디자인 했지..?’</b></p>
          <p>무언가 모를 감정을 정의하는 과정은 꽤나 힘듭니다. <br />충격적이게도 작은 인터렉션에도 의미가 있었던 것입니다.</p>
          <p>&nbsp;</p>
          <p><b>막막한 가운데 갔던 도서관</b></p>
        ...
        <div className="w-full h-full flex flex-col gap-12">
          <div className="w-full flexCenter">
            <TextAlign title="나만의 결론 내기" type="center">
              <div className="flex flex-col gap-2">
                <p>예술이란 <b>의도를 갖고 표현하는 방식을 고민</b>하는 것</p>
        ...
        <div className="w-full flex justify-end">
          <TextAlign title="작업 시 아쉬운 점" type="right">
            <p>이번 작업은 <b>완벽주의라는 틀</b>에 갇혀 많은 생각에 가로막혔습니다.<br />
            많은 욕심으로 머신러닝 프로덕트와 기술력도 탐냈고,<br />화려한 인터렉션에도 홀려 <b>주관을 흐리기도 했습니다.</b></p>
            <p>&nbsp;</p>
            <p>이 현상에 갇힌 것은 저의 <b>“마음 문제”</b>가 가장 크다고 생각합니다. <br />
            작은 욕심을 원동력으로 많은 작업을 서스럼없이 하게 되었을 때 <br />비로소 성장한다는 것을 느꼈습니다.</p>
          </TextAlign>
        </div>
        {/* 왼쪽 정렬 - 의의와 결론 */}
        <div className="w-full flex justify-between items-start pb-10">
          <TextAlign title="의의와 결론" type="left">
            <p><b>이번 작품에서 가장 주요하게 여긴 것</b></p>
            <p> 바로 자신에 대한 연구였는데요 많은 사람은 면접자에 대해 그리 궁금해 하지 않는다고들 합니다. </p>
            
            <p className="mt-2">하지만 <br />
            저의 개발자 인생에 있어서 꼭 필요한 과정이었습니다.<br />
            이후 모든 작업에 자신감을 가져다 주었습니다.</p>
            <p>&nbsp;</p>
            <p><b>무엇을 하던 불확실한 현재</b></p>
            <p>
            오로지 믿은 것은 저 자신이었습니다. <br />겸손과 성찰에 대한 중요성, 자신에 대한 주관을 세울 수 있는 작품이었습니다.
            </p>
          </TextAlign>
        </div>
        </div>
